...
- [x] Create `MarkdownPasteApp.swift` — `@main`, `MenuBarExtra` with SF Symbol `doc.richtext`, `Settings` scene
...
- [ ] Launch the app — verify it appears in the menu bar with the `doc.richtext` icon
...
- [ ] Optional: Create a custom SF Symbol-style menu bar icon (16x16 template image) instead of using `doc.richtext`
